...
<div style={{ position: "relative", boxSizing: "content-box", maxHeight: "80svh", width: "100%", aspectRatio: "1.70", padding: "40px 0" }}>
  <iframe
    src="https://guides.usesyndicate.org/embed/cmqa1p3tt0623qma46alzn2xw?embed_v=2&utm_source=embed"
    loading="lazy"
    title="Syndicate: Team Hub"
