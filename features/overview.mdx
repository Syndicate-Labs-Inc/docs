...
**Dispatch** is how agents run. When you message an agent, when Atlas assigns work, or when a teammate sends a message, the recipient agent wakes up, does the work in the working directory, and reports back. Team coordination is visible in **Dispatch**; anything that needs you lands in **User Tasks**.
...
<CardGroup cols={2}>
  ...
  <Card title="Teams" icon="users" href="/features/teams">
    Navigation, the dashboard, and team controls.
  </Card>
