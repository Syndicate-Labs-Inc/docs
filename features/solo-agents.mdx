...
A solo agent is a workspace with exactly one agent and no Manager. There is no delegation, no task board ceremony, and no Agent Comms: just you and a specialist in a direct conversation.
