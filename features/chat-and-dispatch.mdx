...
During a run the agent sees its Soul, recent conversation, unread inbox messages, and team context, then works in the working directory and reports back. Its tool activity streams live into the chat and the Activity tray.
