...
Syndicate does not only check whether credentials exist. For providers like Codex, it also checks whether the account can actually run. This catches plan, quota, policy, and CLI issues earlier.
