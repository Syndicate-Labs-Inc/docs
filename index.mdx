...
Everything runs locally on your machine, inside a project folder you choose, powered by the AI providers you connect: Claude, OpenAI (Codex), or Google Gemini.
...
- **Extend agents.** Skills, specializations, MCP servers, and reference files shape what each agent knows and can do.
...
<CardGroup cols={2}>
  ...
  <Card title="The Agent Marketplace" icon="store" href="/guides/agent-marketplace">
    Browse 20+ built-in specialists, community packages, and the Agent Maker.
  </Card>
  <Card title="Connect providers" icon="plug" href="/guides/connect-providers">
    Hook up Claude, OpenAI (Codex), or Google Gemini.
  </Card>
</CardGroup>

## How it fits together

A **workspace** is a team or solo agent plus the local project folder it works in. Inside a team, **Atlas** (the Manager) receives your goals, breaks them into tasks on a shared board, and dispatches **agents** to do the work. Agents message each other through **Agent Comms**, and anything that needs your attention lands in **User Tasks** and your **Inbox**.

Read the full mental model in [Core concepts](/features/overview).
