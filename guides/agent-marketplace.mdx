...
The Marketplace (the **Browse Agents** icon in the sidebar) is where every agent specialization lives: Syndicate's built-ins, packages you have made, and packages imported from the community.
...
| **User Made** | Packages you created with [Agent Maker](/guides/agent-marketplace/agent-maker) |
...
<Frame caption="The Add Agent Package modal">
  <img src="/assets/screenshots/agents/agent_marketplace_options.png" alt="The Add Agent Package modal with Agent Maker, Local Folder, GitHub Repository, and CLI Install options" />
</Frame>

The **Add Agent Package** modal offers four methods:

1. **Agent Maker**: describe a specialist and generate a package. The main path for custom agents.
...
<CardGroup cols={2}>
  ...
  <Card title="Agent Maker" icon="wand-magic-sparkles" href="/guides/agent-marketplace/agent-maker">
    Generate a custom specialist from a description.
  </Card>
