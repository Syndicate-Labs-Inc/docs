...
| **User Made** | Packages you created with [Francis](/guides/agent-marketplace/agent-maker) |
...
1. **Francis · Agent Creator**: describe a specialist and Francis builds the package. The main path for custom agents.
...
<CardGroup cols={2}>
  ...
  <Card title="Francis" icon="wand-magic-sparkles" href="/guides/agent-marketplace/agent-maker">
    Describe a specialist and Francis generates the package.
  </Card>
