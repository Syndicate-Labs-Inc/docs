---
title: "Francis"
description: "Describe a specialist in plain language and Francis builds a reusable agent package."
---

Francis is Syndicate's agent creator; the UI labels it **Francis · Agent Creator** wherever it appears. Describe the specialist you want, and Francis drafts the full package: a title, a Soul, and a set of slash-command skills. The result lands in your Marketplace under **User Made**, reusable in any team or solo workspace.

## Create a specialist

<Steps>
  <Step title="Open Francis">
  ...
  <Step title="Describe the agent">
    ...
    <Frame caption="Describe the specialist you want">
      <img src="/assets/screenshots/agents/agent_marketplace_custom_input.png" alt="The custom agent modal with a description field" />
    </Frame>
  </Step>
  <Step title="Generate">
    Click **Generate Agent** (in some flows **Build Skillset**). Status messages stream while Francis works: "Designing the specialist...", "Writing the command set...", "Building the reusable skill package...".
  </Step>
...
Open the package in the Marketplace and click **Edit**. Describe the change ("What should Francis change?") and **Apply Change**.
