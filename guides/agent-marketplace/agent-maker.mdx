...
Francis is Syndicate's agent creator. Describe the specialist you want, and Francis drafts the full package: a title, a Soul, and a set of slash-command skills. The result lands in your Marketplace under **User Made**, reusable in any team or solo workspace.
