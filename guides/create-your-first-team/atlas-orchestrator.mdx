...
<div style={{ position: "relative", boxSizing: "content-box", maxHeight: "80svh", width: "100%", aspectRatio: "1.60", padding: "40px 0" }}>
  <iframe
    src="https://guides.usesyndicate.org/embed/cmqa5gi8q094wqma4joecpscu?embed_v=2&utm_source=embed"
    loading="lazy"
    title="Syndicate: Atlas the Orchestrator"
