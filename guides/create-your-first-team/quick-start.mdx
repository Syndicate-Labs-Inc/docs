...
<div className="supademo-tour-callout">
  <div>
    <strong>Want a quick walkthrough?</strong>
    <p>Take an interactive tour of creating your first Syndicate team.</p>
  </div>
  <button className="supademo-tour-button" data-supademo-id="cmq9zcylq032qqma4821w0yn7">
    Take a tour
  </button>
</div>
