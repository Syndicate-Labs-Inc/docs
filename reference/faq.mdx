...
Yes. Agents run on providers you connect: Claude, OpenAI (Codex, requires a ChatGPT plan with Codex), or Google Gemini. One is enough; you can mix providers within a team. See [Connect providers](/guides/connect-providers).
